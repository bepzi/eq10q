...
static LV2_Handle instantiateBassUp(const LV2_Descriptor *descriptor, double s_rate,
...
static const LV2_Descriptor bassupDescriptor = {
    BASSUP_URI, instantiateBassUp, connectPortBassUp, NULL, runBassUp, NULL, cleanupBassUp, NULL};
