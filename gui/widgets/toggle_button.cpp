...
ToggleButton::ToggleButton(const Glib::ustring& label) : Button(label), m_bActive(false) {}
...
bool ToggleButton::get_active() { return m_bActive; }
...
void ToggleButton::drawLedBtn(Cairo::RefPtr<Cairo::Context> cr, bool focus, bool enabled,
                              std::string text, int margin, int radius, double red, double green,
                              double blue) {
    ...
    Cairo::RefPtr<Cairo::RadialGradient> bkg_gradient_ptr =
        Cairo::RadialGradient::create(margin + 2 * radius - 2, margin + 2 * radius - 2, 0,
                                      margin + 2 * radius, margin + 2 * radius, radius * 3);
    double alpha = 0.3;
    if (enabled) {
        alpha = 0.8;
    }
    ...
    if (enabled) {
        ...
        bkg_gradient_ptr =
            Cairo::RadialGradient::create(margin + 2 * radius, margin + 2 * radius, 0,
                                          margin + 2 * radius, margin + 2 * radius, radius * 4);
