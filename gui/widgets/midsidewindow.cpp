...
MidSideMainWindow::MidSideMainWindow(const char* uri, std::string bundlePath, bool isLR2MS)
    : m_pluginUri(uri), m_bundlePath(bundlePath), m_bisLR2MS(isLR2MS) {
    ...
    if (m_bisLR2MS) {
        ...
        sOut1 = "Out Mid";
        sOut2 = "Out Side";
        m_LabTitle.set_markup(
            "<span font_weight=\"bold\" font=\"12px\" font_family=\"Monospace\"> Matrix: Stereo to "
            "Mid/Side </span>");
    } else {
        sIn1 = "In Mid";
        sIn2 = "In Side";
        ...
        sOut2 = "Out Right";
        m_LabTitle.set_markup(
            "<span font_weight=\"bold\" font=\"12px\" font_family=\"Monospace\"> Matrix: Mid/Side "
            "to Stereo </span>");
    }

    m_InGain1 = Gtk::manage(new KnobWidget2(
        -20.0, 20.0, "Level", "dB", (m_bundlePath + KNOB_ICON_FILE).c_str(), KNOB_TYPE_LIN, true));
    m_InGain2 = Gtk::manage(new KnobWidget2(
        -20.0, 20.0, "Level", "dB", (m_bundlePath + KNOB_ICON_FILE).c_str(), KNOB_TYPE_LIN, true));
    m_OutGain1 = Gtk::manage(new KnobWidget2(
        -20.0, 20.0, "Level", "dB", (m_bundlePath + KNOB_ICON_FILE).c_str(), KNOB_TYPE_LIN, true));
    m_OutGain2 = Gtk::manage(new KnobWidget2(
        -20.0, 20.0, "Level", "dB", (m_bundlePath + KNOB_ICON_FILE).c_str(), KNOB_TYPE_LIN, true));
    ...
    m_OutGain1->signal_changed().connect(
        sigc::mem_fun(*this, &MidSideMainWindow::onOutGain1Change));
    m_OutGain2->signal_changed().connect(
        sigc::mem_fun(*this, &MidSideMainWindow::onOutGain2Change));
