...
public:
    VUWidget(int iChannels, float fMin, float fMax, std::string title, bool IsGainReduction = false,
...
private:
    ...
    // Cairo surfaces
    Cairo::RefPtr<Cairo::ImageSurface> m_background_surface_ptr, m_foreground_surface_ptr,
        m_fader_surface_ptr, m_vu_surface_ptr;
};
#endif
