...
static LV2_Handle instantiateMatrix(const LV2_Descriptor *descriptor, double s_rate,
...
static void runMatrix(LV2_Handle instance, uint32_t sample_count) {
    ...
    for (uint32_t i = 0; i < sample_count; ++i) {
        ...
        plugin_data->output[0][i] =
            plugin_data->RG_in1 * sgn1_pre + plugin_data->RG_in2 * sgn2_pre +
            plugin_data->RG_out11 * sgn1_post + plugin_data->RG_out21 * sgn2_post;

        plugin_data->output[1][i] =
            plugin_data->RG_in1 * sgn1_pre + plugin_data->RG_in2 * sgn2_pre +
            plugin_data->RG_out12 * sgn1_post + plugin_data->RG_out22 * sgn2_post;
    }
...
static const LV2_Descriptor msMatrixDescriptor = {
    MATRIX_URI, instantiateMatrix, connectPortMatrix, NULL, runMatrix, NULL, cleanupMatrix, NULL};
